...
<script src="{{ asset('client/plugins/jquery/jquery.js') }}"></script>
<!-- Bootstrap jQuery -->
...
<script src="{{ asset('client/plugins/slick-carousel/slick.min.js') }}"></script>
<script src="{{ asset('client/plugins/magnific-popup/magnific-popup.js') }}"></script>
<!-- Instagram Feed Js -->
<script src="{{ asset('client/plugins/instafeed-js/instafeed.min.js') }}"></script>
<!-- Google Map -->
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCC72vZw-6tGqFyRhhg5CkF2fqfILn2Tsw"></script>
<script src="{{ asset('client/plugins/google-map/gmap.js') }}"></script>
<!-- main js -->
